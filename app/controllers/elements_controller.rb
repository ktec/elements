class ElementsController < ApplicationController
  ...
  # GET /elements/tree
  # GET /elements/tree;get_children
  # GET /elements/tree;search
  # GET /elements/tree;create_node
  # GET /elements/tree;remove_node
  # GET /elements/tree;rename_node
  # GET /elements/tree;move_node
  def tree
    respond_to do |format|
