...
Rails::Initializer.run do |config|
  ...
  config.active_record.observers = :page_observer ## used to ping google
  ...
  config.gem "validation_reflection" # for validation http://github.com/redinger/validation_reflection
